...
public class Lab10P3Wrapper {
	...
	public static void main(String[] args) {
		...
		Lab10P3Wrapper.DisplayablePriorityQueue<Integer, String> pq = new Lab10P3Wrapper.UnsortedListPriorityQueue<>(new Lab10P3Wrapper.IntegerComparator1());
		Lab10P3Wrapper.add(pq, 20, "twenty");
		Lab10P3Wrapper.removeMin(pq);
		Lab10P3Wrapper.removeMin(pq);
		Lab10P3Wrapper.add(pq, 10, "ten");
		Lab10P3Wrapper.add(pq, 22, "twenty two");
		Lab10P3Wrapper.add(pq, 7, "seven");
		Lab10P3Wrapper.add(pq, 13, "thirteen");
		Lab10P3Wrapper.add(pq, 23, "twenty three");
		Lab10P3Wrapper.add(pq, 100, "hundred");
		Lab10P3Wrapper.add(pq, 9, "nine");
		Lab10P3Wrapper.add(pq, 0, "zero");
		Lab10P3Wrapper.add(pq, 4, "four");
		Lab10P3Wrapper.add(pq, 8, "eight");
		Lab10P3Wrapper.add(pq, 3, "three");
		Lab10P3Wrapper.removeMin(pq);
		Lab10P3Wrapper.removeMin(pq);
		Lab10P3Wrapper.removeMin(pq);
		Lab10P3Wrapper.add(pq, 9, "nine");
