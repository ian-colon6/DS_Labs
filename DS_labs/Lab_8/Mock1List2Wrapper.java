...
public class Mock1List2Wrapper {
	...
	public static class SinglyLinkedList<E extends Comparable<E>> implements List<E> {
		...
		/**
		 * Write a member method that merges the target list with the list given as
		 * parameter.
		 * You can assume that the target list will be sorted by calling the sort()
		 * method.
		 * The method should modify the original target list such that it has both lists
		 * sorted.
		 * 
		 * If L1 = {2,4,1,3,5} and L2 = {6,7,8,9,10}, then a call to
		 ...
		 * 
		 * Example: If you have elm1 and elm2, elm1.compareTo(elm2) returns the
		 * following values:
		 * 1) 0, if elm1 == elm2
		 * 2) 1, if elm1 > elm2
		 * 3) -1, if elm1 < elm2
		...
		public static void main(String[] args) {
			...
			SinglyLinkedList<Integer> nums2 = new SinglyLinkedList<Integer>();
			...
			nums.mergeTwoSortedLists(nums2);
